...
class ImagePlot :
    ...
    def callback(self, msg) :
        ...
        scan = np.array(self.cv_bridge.imgmsg_to_cv2(msg, desired_encoding="passthrough"))
        ...
        for i in range(len(img)):
            for j in range(len(img[0])):
                ...
                elif h< self.max_hue_green or h>self.min_hue_green:
